...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Phoenix " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"159.203.175.204", "159.203.175.204"},
    {"159.65.81.116", "159.65.81.116"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Phoenix is probably already running."), addrBind.ToString().c_str());
        else
